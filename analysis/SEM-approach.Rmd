...
The model fit is shown in Figure 1. However, the model did not fit well: $\chi^2 = `r round(o1$ch,2)`$, $df = `r o1$df`$, and most importantly, $RMSEA = `r o1$rmsea`$, $CFI = `r o1$cfi`$, $SRMR = `r o1$srmr`$, and $TLI = `r o1$tli`$. The model fit of Model 1 is shown in Table 1.
